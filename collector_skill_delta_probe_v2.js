  ...
  function makePanel() {
    ...
    panel.innerHTML = `
      ...
      ">
        ...
        <button id="jsdp2_start">
          ① 最新一覧を確認
        </button>

        <button id="jsdp2_stop">
          停止
        </button>

        <button id="jsdp2_show">
          ② 差分表示
        </button>

        <button id="jsdp2_share">
          差分JSON保存
        </button>

        <button id="jsdp2_copy">
          JSON全文コピー
        </button>

        <button id="jsdp2_reset">
          今回分リセット
        </button>
    ...
    style.textContent = `
      #jolly_skill_delta_panel_v2 button {
        border:0;
        border-radius:10px;
        padding:9px 7px;
        background:#fff;
